...
WebUI.setText(findTestObject('Page_Ontro/input_email'), 'bala@ontroa')
...
WebUI.click(findTestObject('Page_Ontro/a_workPlans'))
...
WebUI.setText(findTestObject('Page_Ontro/input_form-control'), 'Twice')
